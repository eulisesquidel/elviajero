...
class Menu1_item_base { 
	...
	function Menu1_item_base($Id='') { 

		$this->_entidad_base = 'MENU1_ITEMS'; 
	...
	function _bindValues(){
		$this->_prop['ID']['VALUE'] = $this->Id;
		$this->_prop['NOMBRE']['VALUE'] = $this->Nombre;
		$this->_prop['LINK']['VALUE'] = $this->UrlLink;
		$this->_prop['ID_RAIZ']['VALUE'] = $this->Id_raiz;
	} //end function _bindValues

} //end class Menu1_item_base

class Menu1_items_base { 
	...
	function Menu1_items_base() { 
		$this->_item_class = new Menu1_item_base();
