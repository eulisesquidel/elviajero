...
//	document.write('<form>');
	...
	document.write('	</td>');
	document.write('	<td class="CALENDARTITLE" align="left" colspan="3"><img src="' + imgsrc + 'next.gif" onclick="cal_after(' + day + ',' + month + ',' + year + ');">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="' + imgsrc + 'clear.gif" onclick="clearDate();">&nbsp;&nbsp;<img src="' + imgsrc + 'close.gif" onclick="hideCalendar()"></td>');
...
/**
 * Agregado para permitir al calendario eliminar valores.
 */
function clearDate(){
...
function ValidarCambiosPremios(){
 alert("Prueba EULISES");
 return true; 
}
