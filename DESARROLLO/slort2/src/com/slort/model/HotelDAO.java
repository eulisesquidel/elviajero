...
public class HotelDAO extends HibernateDaoSupport {
	...
	public List<Hotel>  findByGUIPosibilities(Hotel objeto){
	...
	public List<Hotel>  findByGUIPosibilitiesReserva(String criterio){

		DetachedCriteria criteria = DetachedCriteria.forClass(Hotel.class);
		criteria.add(Restrictions.ilike("nombre", BDBUtils.AdaptarLike( BDBUtils.AdaptarCamposNulos(criterio))));
		return  getHibernateTemplate().findByCriteria(criteria);
