...
/**
 * AbstractFlota generated by MyEclipse Persistence Tools
 */
...
public abstract class AbstractFlota implements java.io.Serializable {
	...
	public AbstractFlota(Integer codUnidad, Byte activo, String userYahoo,
			...
			Set historicoubicaciondetalles, String consumerKeyYahoo, 
	...
	public String getFlotaCompleta() {
		if (this.licencia==null) return "";
		return this.licencia+" - "+this.nombre+" - "+this.apellido;
	}
