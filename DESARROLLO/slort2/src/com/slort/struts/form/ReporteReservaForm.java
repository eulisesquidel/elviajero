...
public class ReporteReservaForm  extends ActionForm {
	...
	public List<Reserva> getListaResultado() {
		return listaResultado;
	}
	public void setListaResultado(List<Reserva> listaResultado) {
