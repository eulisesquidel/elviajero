...
public class DateUtils {
    ...
    static  {
        log = Logger.getLogger(com.bdb.util.DateUtils.class);
    }
    ...
    public static String sumarRestarHoraActual(Integer horas) {
        SimpleDateFormat sdf = new SimpleDateFormat("HH:mm");
        String ret = null;
        Calendar c1 = Calendar.getInstance();
        c1.add(Calendar.HOUR, horas);
        ret = sdf.format(c1.getTime()); 
        log.debug("sumarRestarHoraActual(H:mm) retorna " + ret);
        return ret;
    }
    ...
    public static String getHora(Date hora) {
        ...
        String ret = null;
        ret = sdf.format(hora);
        log.debug("getHora(H:mm) retorna " + ret);
        return ret;
    }
