...
public class ConvertirNumero 
{
	...
	public static String convertirLetras(float numero)
	{				
		StringTokenizer strTok = new StringTokenizer(numero+"");
		
		int entera = Integer.parseInt(strTok.nextToken("."));
		int decimal = Integer.parseInt(strTok.nextToken("."));
						
		if(decimal == 0)
			return "Pesos " + decmillon(entera) + " con cero centavos";		
		
		return "Pesos " + decmillon(entera)+ " con " + decmillon(decimal) + " centavos";
	} 	
}
