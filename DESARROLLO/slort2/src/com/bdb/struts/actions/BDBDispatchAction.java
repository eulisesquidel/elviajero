...
public class BDBDispatchAction extends DispatchAction {
    ...
    public Usuario getUsuario(HttpServletRequest  request){
    	return (Usuario)request.getSession().getAttribute("bdbUser");	
    }
    ...
    public ApplicationContext getSpringApplicationContext(HttpServletRequest request)  {
    	log.debug("getBean");
    	return (ApplicationContext) this.servlet.getServletContext().getAttribute("applicationContext");
    }
    ...
    public Connection  getJDBCConnection()  {
		...
		log.debug("getBean");
    	ApplicationContext applicationContext =(ApplicationContext) this.servlet.getServletContext().getAttribute("applicationContext");
    	BasicDataSource un_BasicDataSource = (BasicDataSource) applicationContext.getBean("datasource");
    	
    	try {
			return un_BasicDataSource.getConnection();
