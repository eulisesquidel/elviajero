...
<meta http-equiv="refresh" content="1;URL='<jsp:getProperty name="opcionDefecto" property="link"/>'">

<jsp:useBean id="opcionDefecto" class="com.slort.model.Opcionmenu" scope="session"/>
<html>
	<head>
		<title>Welcome</title>
	</head>
