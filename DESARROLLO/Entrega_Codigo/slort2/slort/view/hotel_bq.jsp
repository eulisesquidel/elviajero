...
<template:insert template='templates/default.jsp'>
	...
	<template:put name='content'>
		...
		<layout:form action="/hotel.do" styleClass="Body" reqCode="">
			...
			<layout:text key="HotelForm.grilla_bq.nombre" 
									 property="nombre" 
									 styleClass="LABEL" 
									 mode="E,E,I"
									 size="30"
		  ...
		  <layout:formActions>
			...
			<logic:present name="foundResults" scope="request">
					...
					<layout:collection name="foundResults" id="objeto" styleClass="FORM"
							...
							<layout:collectionItem title="HotelForm.grilla_bq.idHotel" name="objeto"  property="idHotel" styleClass="negro-nor-2"/>
							<layout:collectionItem title="HotelForm.grilla_bq.nombre" name="objeto" property="nombre" styleClass="negro-nor-2"/>
	 
							<%-- Edit button --%>
							<layout:collectionItem title="label.edit" styleClass="negro-nor-2" >
								<layout:link 
										href="hotel.do?reqCode=edit" 
										paramId="selectedId" 
										paramName="objeto" 
										paramProperty="idHotel">
