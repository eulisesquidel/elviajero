...
public abstract class AbstractPerfil implements java.io.Serializable {
	...
	private Set opcionmenuPerfiles = new HashSet(0);
	...
	public AbstractPerfil(Integer idPerfil, String descripcionCorta,
			...
			Set opcionmenuPerfils, Set OpcionmenuPerfiles) {
		this.idPerfil = idPerfil;
		this.descripcionCorta = descripcionCorta;
		this.descripcionLarga = descripcionLarga;
		...
		this.opcionmenuPerfiles = OpcionmenuPerfiles;
	}
	...
	public Set<OpcionmenuPerfil> getOpcionmenuPerfiles() {
		return opcionmenuPerfiles;
	}

	public void setOpcionmenuPerfiles(Set<OpcionmenuPerfil> opcionmenuPerfiles) {
		this.opcionmenuPerfiles = opcionmenuPerfiles;
	}
