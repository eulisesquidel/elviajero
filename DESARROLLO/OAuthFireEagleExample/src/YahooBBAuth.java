...
public class YahooBBAuth {	
	...
	public static void main(String[] args) {
		try {
			 ...
			 */
			String appId = "eGt2oD_IkY3Q9vWbSCktqjQBQ5R5Rcm.pno-";
			String secret = "dd968ec5273455e94abc2611cea33e83";
            ...
            String authURL = "https://api.login.yahoo.com" + authWS + "?appid=" + appId + "&appdata=" + appData + "&ts=" + time + "&sig=" + signature;
            /**
